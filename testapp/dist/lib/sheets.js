...
exports._clearGoogleSheetData = exports._getExistingSheetData = exports._writeGoogleSheet = exports._readGoogleSheet = exports._getGoogleSheetClient = void 0;
...
async function _getExistingSheetData(googleSheetClient, sheetId, tabName, range) {
    const res = await googleSheetClient.spreadsheets.values.get({
        spreadsheetId: sheetId,
        range: `${tabName}!${range}`,
    });
...
async function _clearGoogleSheetData(googleSheetClient, sheetId, tabName, range) {
